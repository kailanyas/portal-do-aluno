    ...
    <div class="content-area">
      ...
      <main class="main-content">
        <CardQuadrado class="form-card" maxWidth="200rem">
          <h2>Solicitação de Atividades Complementares</h2>

          <div class="instructions-section">
            <p class="centered-paragraph">
              Se você já realizou uma atividade complementar, utilize esta seção para
            ...
            <ul>
              ...
              <li>Clique em editar para alterar ou excluir uma solicitação que ainda não foi avaliada.</li>
            </ul>
          </div>
