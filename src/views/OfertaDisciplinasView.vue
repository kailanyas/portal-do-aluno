...
function solicitarTodas() {
    if (disciplinasAdicionadas.value.length === 0) {
        alert("Nenhuma disciplina foi adicionada para solicitar.");
        return;
    }
    console.log("--- SOLICITAÇÃO ENVIADA ---", disciplinasAdicionadas.value);
    alert(`Solicitação de ${disciplinasAdicionadas.value.length} disciplina(s) enviada com sucesso!`);
    disciplinasAdicionadas.value = [];
}
            ...
            <main class="main-content">
                <div class="dropdown-view">
                    ...
                    <div v-if="disciplinasAdicionadas.length > 0" class="solicitacao-final-actions">
                        <button class="btn-solicitar-final" @click="solicitarTodas">
